"use strict";
const wxcomponents_vantWeapp_dist_common_validator = require("../common/validator.js");
...
function parseOptions(message) {
  return wxcomponents_vantWeapp_dist_common_validator.isObj(message) ? message : { message };
}
function getContext() {
